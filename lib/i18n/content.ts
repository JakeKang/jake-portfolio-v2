...
const koContent: PortfolioContent = {
  ...
  personalInfo: {
    ...
    bio: [
      '· React/Next.js 기반 프론트엔드 설계·개발·운영 경험이 있습니다.',
      '· 레거시 현대화와 렌더링 최적화로 성능 문제를 구조적으로 해결해왔습니다.',
      '· 검색 응답 93% 단축, 페이지 로딩 80% 개선 등 측정 가능한 성과를 만들었습니다.',
      '· Claude Code를 활용한 기능 검증과 테스트 방식을 실험하고 팀에 공유하고 있습니다.',
  ...
  hero: {
    ...
    introSuffix: '입니다',
    profileAlt: '프로필 사진',
    taglineLine1: '기술보다 문제에 먼저 몰입합니다.',
    taglineLine2:
      '복잡한 것을 단순하게 만드는 일이 좋은 제품을 만든다고 믿습니다.',
  ...
  about: {
    title: '소개',
    headline:
      '기술, 비즈니스, 사용자 경험을 함께 고려하며 더 나은 제품을 만듭니다.',
  },
  projects: {
...
const enContent: PortfolioContent = {
  ...
  personalInfo: {
    ...
    email: 'gksmfcjs91@gmail.com',
    bio: [
      '· I have hands-on experience designing, building, and operating frontend systems with React and Next.js.',
      '· I have solved performance issues structurally through legacy modernization and rendering optimization.',
      '· I have delivered measurable outcomes, including a 93% reduction in search response time and an 80% improvement in page load speed.',
      '· I experiment with feature validation and testing workflows using Claude Code and share practical findings with the team.',
      '· I find joy in growing through the process of thinking and improving together with the team.',
    ],
    socialLinks: [
      { label: 'GitHub', href: 'https://github.com/JakeKang', icon: 'github' },
      {
  ...
  hero: {
    ...
    taglineLine1: 'I focus on problems before technology.',
    taglineLine2: 'I believe making complexity simple creates better products.',
  ...
  about: {
    title: 'About',
    headline:
      'I value the balance between technology, business, and user experience.\nWithin that balance, I shape products into practical value.',
  },
  projects: {
  ...
  faqSection: {
    title: 'Q&A',
    subtitle: 'A collection of my practical experiences and thoughts.',
  },
  faqs: [
    {
